<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrarCliente.aspx.cs" Inherits="SeguridadFrontEnd.RegistrarCliente" %>
...
<main role="main">
        ...
        <h1 class="jumbotron-heading">Registrar Cliente</h1>
        </section>
            <div class="container">
                <div class="row">
                    <div id="login" class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-12" >
                        ...
                        <form runat="server">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" Id="txtidRCliente" class="form-control"  placeholder="CodCliente" />
                            </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="palabraSecreta">Dirección</label>
                                <asp:TextBox runat="server" Id="txtIdRDireccion" class="form-control"  placeholder="Dirección" />
